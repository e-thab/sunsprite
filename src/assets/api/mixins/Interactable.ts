import { clock, paused, getGamePoint, scene, PointerEvents } from "@api/core"
import type { MouseInputAction, Optional, PointerAction, ReferenceObject, ScrollAction } from "@api/types"
