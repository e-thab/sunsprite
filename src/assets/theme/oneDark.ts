...
const oneDark: ThemePalette = {
    ...
    tokens: {
        ...
        string: { color: '#98c379' },
        stringEscape: { color: '#e06c75' },
        comment: { color: '#878d97', style: 'italic' },
        commentDoc: { color: '#98c379' },
        regexp: { color: '#e06c75' },
        bracketColor1: '#c678dd',
        bracketColor2: '#e5c07b',
        bracketColor3: '#56b6c2',
        bracketColorUnexpected: '#e06c75',
    }
}
